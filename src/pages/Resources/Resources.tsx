...
const resources = [
  ...
  { icon: Video, title: 'Video Tutorials', description: 'Recorded workshops and conference talks from Antcode Technology events.', count: '36 videos' },
  ...
  return (
    <div className="flex flex-col">
      <PageHero
        ...
        description="Free resources, guides, and tools from the Antcode Technology team."
      />
      ...
      <Section className="bg-surface/30 text-center">
        ...
        <p className="text-muted mb-8">Join Antcode Technology Academy for structured courses and mentorship.</p>
